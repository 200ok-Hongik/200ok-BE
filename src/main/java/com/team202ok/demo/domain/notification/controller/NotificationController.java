...
public class NotificationController {
    ...
    public List<HomeRes.NotificationItem> getRecentNotifications(@Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    ...
    public PushDeviceRes registerDevice(@Parameter(hidden = true) @AuthenticationPrincipal Long userId, @Valid @RequestBody PushDeviceReq.Register request) {
    ...
    public void removeDevice(@Parameter(hidden = true) @AuthenticationPrincipal Long userId, @Valid @RequestBody PushDeviceReq.Remove request) {
    ...
    public int sendTestPush(@Parameter(hidden = true) @AuthenticationPrincipal Long userId, @RequestBody(required = false) TestPushReq request) {
